...
class Handler(BaseHandler):
    ...
    def __init__(self):
        self.urls={
            "http://www.stuff.co.nz/rss/dominion-post/business" : "business",
            "http://www.stuff.co.nz/rss/dominion-post/technology" : "technology",
            "http://www.stuff.co.nz/rss/dominion-post/sport" : "sport",
            "http://www.stuff.co.nz/rss/dominion-post" : "dominion-post",
        }
