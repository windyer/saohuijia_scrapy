...
class Handler(BaseHandler):
    ...
    def __init__(self):
        self.urls={
            "http://www.stuff.co.nz/rss/taranaki-daily-news" : "taranaki-daily-news",
            "http://www.stuff.co.nz/rss/taranaki-daily-news/business" : "business",
            "http://www.stuff.co.nz/rss/taranaki-daily-news/sport" : "sport",
            "http://www.stuff.co.nz/rss/taranaki-daily-news/entertainment" : "entertainment",
        }
    ...
    def detail_page(self, response):
        ...
        data = {
            ...
            "ImageNum": len(images),
            "Language": 1,
            "NewsSource": "taranaki-daily-news",
            "Link": response.url,
            "PlainText":re.sub('\n+','\n',text.replace("  ","")),
        }
        #sql.into(**data)
