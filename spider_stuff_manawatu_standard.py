...
class Handler(BaseHandler):
    ...
    def __init__(self):
        self.urls={
            "http://www.stuff.co.nz/rss/manawatu-standard" : "manawatu-standard",
            "http://www.stuff.co.nz/rss/manawatu-standard/business" : "business",
            "http://www.stuff.co.nz/rss/manawatu-standard/sport" : "sport",
        }
